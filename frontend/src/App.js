...
import AdminStefaniaChat from "./components/admin/AdminStefaniaChat";
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <div className="flex-1 overflow-y-auto p-5" style={{ background: '#FAFAF7' }}>
          ...
          {mode==="admin"&&<>
            ...
            {nav==="stefania"&&<AdminStefaniaChat currentUser={currentUser}/>}

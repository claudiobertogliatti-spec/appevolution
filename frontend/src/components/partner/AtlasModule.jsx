            ...
            <div className="bg-white border border-[#ECEDEF] rounded-xl p-5">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono font-bold text-[#0F172A]">{ltvData.students?.total || 0}</span>
                </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-[#FAFAF7] rounded-lg p-3 text-center">
                    <div className="font-mono text-2xl font-bold text-[#0F172A]">{ltvData.referrals?.total || 0}</div>
            ...
            {students.length === 0 ? (
              ...
              students.map(student => (
                <div key={student.id} className="p-4 flex items-center gap-4 hover:bg-[#FAFAF7]">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-yellow-500 to-amber-500 flex items-center justify-center text-[#0F172A] font-bold">
                    ...
                    <div key={bonus.id} className="bg-[#FAFAF7] border border-[#ECEDEF] rounded-xl p-4">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="font-bold text-[#0F172A]">{bonus.title}</div>
          ...
          <div className="bg-white border border-[#ECEDEF] rounded-xl p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-gradient-to-r from-pink-500 to-purple-500 text-[#0F172A] rounded-lg px-4 py-2 text-sm font-bold hover:opacity-90 disabled:opacity-50"
              >
        ...
        <div className="space-y-4">
          <div className="bg-gradient-to-br from-pink-900/20 to-purple-900/10 border border-pink-500/30 rounded-xl p-5">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h3 className="text-lg font-extrabold text-[#0F172A]">Feedback-to-Copy Bridge</h3>
                ...
                {copyAngles.map(angle => {
                  ...
                  return (
                    <div key={angle.id} className="bg-white border border-[#ECEDEF] rounded-xl p-4">
                      ...
                      <h4 className="font-bold text-[#0F172A] mb-2">{angle.headline}</h4>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 text-xs text-[#9CA3AF] hover:text-[#0F172A]"
                        >

    ...
    return (
      <div className="max-w-2xl mx-auto animate-slide-in" data-testid="wizard-generating">
        <div className="bg-white border border-[#ECEDEF] rounded-xl p-12 text-center">
          ...
          <div className="text-lg font-extrabold text-[#0F172A] mb-2">
        ...
        <div className="bg-white border border-[#ECEDEF] rounded-xl overflow-hidden">
          ...
          <div className="p-5 border-b border-[#ECEDEF] bg-gradient-to-r from-[#FFD24D]/20 to-transparent">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-extrabold text-[#0F172A]">Canvas Posizionamento Completato</div>
      ...
      <div className="bg-white border border-[#ECEDEF] rounded-xl overflow-hidden">
        ...
        <div className="p-6 border-b border-[#ECEDEF]">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="text-lg font-extrabold text-[#0F172A] leading-snug">
              {question.question}
            </div>
          </div>
        ...
        <div className="p-6">
          <textarea
            ...
            className="w-full bg-[#FAFAF7] border border-[#ECEDEF] rounded-xl px-4 py-4 text-sm font-semibold text-[#0F172A] placeholder:text-[#9CA3AF] outline-none transition-colors focus:border-[#FFD24D] resize-none min-h-[160px] leading-relaxed"
          />
        </div>

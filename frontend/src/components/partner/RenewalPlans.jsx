...
export function RenewalPlans({ partnerName, currentRevenue, onSelectPlan }) {
  ...
  return (
    <div className="py-6" data-testid="renewal-plans">
      ...
      {/* Current Stats */}
      {currentRevenue > 0 && (
        <div className="bg-gradient-to-r from-[#1a2332] to-[#2c3e55] rounded-xl p-6 mb-8 text-[#0F172A]">
            ...
            >
              ...
              <div className="px-6 py-4">
                <button
                  ...
                  className="w-full py-3 rounded-xl font-bold text-[#0F172A] flex items-center justify-center gap-2 transition-all hover:opacity-90"
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl" data-testid="confirm-modal">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 rounded-xl font-bold text-[#0F172A] transition-colors"

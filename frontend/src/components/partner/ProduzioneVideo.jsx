        ...
        <div className="bg-white border border-[#ECEDEF] rounded-xl overflow-hidden">
          <div className="p-4 border-b border-[#ECEDEF] bg-gradient-to-r from-yellow-500/10 to-transparent">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-extrabold text-[#0F172A]">Pre-Flight Checklist</div>
          ...
          <div className="bg-white border border-[#ECEDEF] rounded-xl overflow-hidden">
            <div className="p-4 border-b border-[#ECEDEF] bg-gradient-to-r from-blue-500/10 to-transparent">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-extrabold text-[#0F172A]">Teleprompter — Script a Blocchi</div>
                  <div className="text-xs text-[#9CA3AF]">
              ...
              {BLOCK_CONFIG.map((blockConfig, index) => {
                ...
                return (
                  <div key={blockConfig.id} className="border border-[#ECEDEF] rounded-lg overflow-hidden">
                    ...
                    >
                      <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${blockConfig.color} flex items-center justify-center text-[#0F172A] font-bold text-xs`}>
                        {index + 1}
                      </div>
                      <div className="flex-1">
                        <div className="text-sm font-bold text-[#0F172A]">{blockConfig.label}</div>
                      ...
                      <div className="p-4 border-t border-[#ECEDEF] bg-[#FAFAF7]">
                        ...
                        {block?.status !== 'approved' && (
                          <div className="flex gap-2">
                            <label className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-[#0F172A] rounded-lg px-4 py-3 text-sm font-bold cursor-pointer hover:opacity-90 transition-opacity">
                              {isUploading ? (
            ...
            {allBlocksApproved && (
              <div className="p-4 border-t border-[#ECEDEF] bg-gradient-to-r from-green-500/10 to-transparent">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-green-500 to-emerald-500 text-[#0F172A] rounded-xl px-6 py-4 text-sm font-extrabold hover:opacity-90 transition-opacity"
                >

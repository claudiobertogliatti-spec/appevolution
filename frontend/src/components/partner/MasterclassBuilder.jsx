      ...
      <div className="space-y-4">
        ...
        <div className="bg-gradient-to-br from-[#1a2332] to-[#2c3e55] rounded-xl p-5">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-lg font-extrabold text-[#0F172A]">Script Builder — 6 Blocchi</h2>
          ...
          <div className="mt-3 flex items-center justify-between">
            ...
            <button
              ...
              className={`text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1 transition-colors ${showGoldenRules ? "bg-pink-500 text-[#0F172A]" : "bg-[#FAFAF7] text-[#9CA3AF] hover:bg-[#ECEDEF]"}`}
            >
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={approving}
                className="flex-1 flex items-center justify-center gap-2 bg-green-500 text-[#0F172A] rounded-lg px-4 py-2 text-sm font-bold hover:bg-green-600 disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={approving}
                className="flex-1 flex items-center justify-center gap-2 bg-orange-500 text-[#0F172A] rounded-lg px-4 py-2 text-sm font-bold hover:bg-orange-600 disabled:opacity-50"
              >
            ...
            <input
              ...
              className="w-full mt-2 bg-[#FAFAF7] border border-[#ECEDEF] rounded-lg px-3 py-2 text-sm text-[#0F172A] placeholder:text-[#9CA3AF]"
            />
          </div>
        )}
              ...
              {goldenRules.map(rule => (
                <div key={rule.num} className="bg-[#FAFAF7] border border-[#ECEDEF] rounded-lg p-2 text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-[#0F172A]">{rule.title}</span>
                  </div>
        ...
        {(status === "draft" || status === "new") && (
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-[#0F172A] rounded-xl px-4 py-3 text-sm font-extrabold hover:opacity-90 transition-opacity disabled:opacity-50"
          >
            {generatingDraft ? (
              <>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-extrabold text-[#0F172A]">{block.label}</span>
                ...
                {isExpanded && (
                  <div className="px-4 pb-4 border-t border-[#ECEDEF]">
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#FAFAF7] border border-[#ECEDEF] rounded-lg px-4 py-3 text-sm text-[#0F172A] placeholder:text-[#9CA3AF] outline-none focus:border-pink-500/50 transition-colors resize-none min-h-[120px]"
                    />
          ...
          {status !== "approved" && status !== "pending_partner_approval" && (
            <>
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-pink-500 to-purple-500 text-[#0F172A] rounded-xl px-4 py-3 text-sm font-extrabold hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
              >

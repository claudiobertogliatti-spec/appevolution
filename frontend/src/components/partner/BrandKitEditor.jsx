    ...
    <div className="bg-white border border-[#ECEDEF] rounded-xl overflow-hidden" data-testid="brand-kit-editor">
      ...
      <div className="p-5 border-b border-[#ECEDEF] bg-gradient-to-r from-[#FFD24D]/10 to-transparent">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-extrabold text-[#0F172A]">Brand Kit</h3>
      ...
      <div className="p-5 space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  value={brandKit.brand_color}
                  onChange={e => updateField('brand_color', e.target.value)}
                  className="flex-1 bg-[#FAFAF7] border border-[#ECEDEF] rounded-lg px-3 py-2 text-sm font-mono text-[#0F172A] uppercase"
                />
              </div>
            </div>
            <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <input
                ...
                className="w-full bg-[#FAFAF7] border border-[#ECEDEF] rounded-lg px-4 py-2.5 text-sm text-[#0F172A] placeholder:text-[#9CA3AF] outline-none focus:border-[#FFD24D] transition-colors"
              />
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-[#FAFAF7] border border-[#ECEDEF] rounded-lg px-4 py-3 text-sm text-[#0F172A] placeholder:text-[#9CA3AF] outline-none focus:border-[#FFD24D] transition-colors"
          />
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <input
              ...
              placeholder="Email"
              className="bg-[#FAFAF7] border border-[#ECEDEF] rounded-lg px-4 py-2.5 text-sm text-[#0F172A] placeholder:text-[#9CA3AF] outline-none focus:border-[#FFD24D]"
            />
            <input
              type="url"
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 bg-[#FAFAF7] border border-[#ECEDEF] rounded-lg px-4 py-2 text-sm text-[#0F172A] placeholder:text-[#9CA3AF] outline-none focus:border-[#FFD24D]"
              />
            </div>
            <div className="flex items-center gap-2">

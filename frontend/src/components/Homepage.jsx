...
export function Homepage() {
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#FAFAF7' }}>
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="max-w-2xl w-full text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-lg transition-all hover:opacity-90 hover:scale-105"
          ...
          {/* Secondary CTA */}
          <div className="mt-12 pt-8" style={{ borderTop: '1px solid #ECEDEF' }}>
            <p className="text-sm mb-4" style={{ color: '#9CA3AF' }}>
              Sei già partner Evolution PRO?
            </p>
            <a
              href="/partner-login"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-medium text-sm transition-all hover:opacity-80"
      ...
      {/* Footer */}
      <footer className="py-8 text-center" style={{ borderTop: '1px solid #ECEDEF' }}>

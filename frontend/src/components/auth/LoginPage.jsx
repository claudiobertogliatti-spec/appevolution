...
export function LoginPage({ onLogin }) {
  ...
  return (
    <div className="min-h-screen bg-[#0B0E14] flex items-center justify-center p-4" data-testid="login-page">
      {/* Background pattern */}
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-[#111827] border border-white/10 rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Email */}
            <div>
              <label className="text-sm font-semibold text-white/60 mb-1.5 block">
                Email
              </label>
              <input
                type="email"
                ...
                required
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-[#F5C518] outline-none transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 pr-12 text-sm focus:border-[#F5C518] outline-none transition-colors"

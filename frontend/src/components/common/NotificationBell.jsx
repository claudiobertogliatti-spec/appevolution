  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        ...
        {unread > 0 && (
          <div className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-[#dc2626] text-[#0F172A] text-[9px] font-bold flex items-center justify-center border-2 border-[#1a2332]">
            {unread}
          </div>
        )}
      </div>

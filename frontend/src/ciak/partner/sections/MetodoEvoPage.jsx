...
export function MetodoEvoPage({ partnerId }) {
  ...
  return (
    <div className="min-h-screen bg-white font-[Poppins,system-ui,sans-serif] text-slate-900 pb-16">
                    ...
                    >
                      ...
                      <div className="pt-3 border-t border-slate-200/60 flex items-center justify-between text-xs">
                        {isDone ? (
                          ...
                          >
                            <Eye className="h-3.5 w-3.5 text-amber-600" /> Visualizza materiali
                          </button>
                        ) : isInProgress ? (
                          <Link
                            to="/partner"
      ...
      {selectedStepModal && <StepMaterialsModal partnerId={partnerId} step={selectedStepModal} onClose={() => setSelectedStepModal(null)} />}

...
const STEP_COPY = {
  ...
  "09-funnel-asset": { title: "Le pagine di vendita", desc: "I materiali con cui costruiamo le pagine." },
  "10-funnel-team-work": { title: "Costruiamo le pagine", desc: "Le montiamo noi per te, pezzo per pezzo." },

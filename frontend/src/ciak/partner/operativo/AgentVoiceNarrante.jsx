...
const DEFAULT_BRIEFING = {
  ...
  "07-script-videolezioni":  "Ora preparo gli script delle videolezioni, una traccia chiara per registrare senza improvvisare.",
  "08-registra-masterclass": "Registra la masterclass e caricala qui. Te la sistemiamo noi.",
  "09-registra-lezioni":     "Registra le lezioni una a una e caricale qui.",
  "10-sistema-vendita":      "Prepariamo subaccount Systeme, dominio, legal pages, funnel, checkout e automazioni.",
  "11-calendario-30gg":      "Creiamo il calendario per i 30 giorni di lancio. Se vuoi i contenuti pronti, possiamo farli noi come extra.",

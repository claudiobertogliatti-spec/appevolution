/**
 * Anteprima Interattiva dal Vivo: Pagina Percorso Area Partner CIAK (Protocollo EVO).
 * Sfondo Bianco Puro (#FFFFFF) con mappa completa delle 14 Fasi raggruppate in 3 Macro-Fasi
 * e funzionalità di Ispezione/Modifica per ogni step.
 */
import React from "react";
import { CiakHeader } from "../components/CiakHeader";
import { CiakFooter } from "../components/CiakFooter";
import { MetodoEvoPage } from "../partner/sections/MetodoEvoPage";
import { Home, Map, FolderOpen, Users, Sparkles, RefreshCw } from "lucide-react";

export function CiakPartnerPercorsoDemo() {
  return (
    <>
      <CiakHeader />
      ...
      <main className="bg-white min-h-screen font-[Poppins,system-ui,sans-serif] text-slate-900 border-t border-slate-100">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-8 py-8 px-4">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm space-y-6">
              <div>
                ...
                <nav className="space-y-1.5">
                  ...
                  <a href="/percorso-demo" className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl bg-slate-950 text-yellow-400 font-extrabold text-xs shadow-sm">
          ...
          <div className="min-w-0">
            <MetodoEvoPage partnerId="demo_mario_rossi" />
          </div>

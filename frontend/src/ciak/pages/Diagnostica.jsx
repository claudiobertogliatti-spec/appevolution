...
const QUESTIONS = [
  {
    id: "q1_competenza",
    text: "Qual è la competenza su cui hai costruito il tuo lavoro? E questo lavoro ha un nome, un metodo o un marchio tuo — un libro, un percorso, una tecnica che hai codificato?",
    type: "text",
    placeholder: "Cosa sai fare davvero bene, e come lo chiami...",
    minLen: 20,
  },
  {
    id: "q2_esperienza",
    text: "Da quanto la pratichi, come sei arrivato/a a padroneggiarla, e a quante persone l'hai già insegnata o erogata?",
    type: "text",
    placeholder: "Il tuo percorso e quante persone hai già seguito...",
    minLen: 20,
  },
  {
    id: "q3_clienti",
    text: "Con chi hai già lavorato su questo tema, e ti hanno pagato per questo? Raccontami un risultato concreto che hai aiutato a ottenere.",
    type: "text",
    placeholder: "Un caso reale, un risultato, e se era un cliente pagante...",
    minLen: 20,
  },
  {
    id: "q4_idea",
    text: "Se immagini un tuo corso o percorso digitale, cosa ti vedi offrire? Ce l'hai già un'offerta a pagamento, o è ancora un'intuizione?",
    type: "text",
    placeholder: "Cosa offri già, o cosa hai in mente...",
    minLen: 20,
  },
  {
    id: "q9_materiale",
    text: "Che materiale hai già creato sul tuo tema — un libro, un podcast, un videocorso, delle dispense, una masterclass? Raccontami cosa esiste già, anche se grezzo.",
    type: "text",
    placeholder: "Tutto ciò che hai già prodotto, anche non finito...",
    minLen: 2,
  },
  {
    id: "q5_target",
  ...
  {
    id: "q10_agenzie",
    text: "Ti sei già affidato ad agenzie o consulenti per portare online il tuo lavoro? Com'è andata, e cosa ti è mancato?",
    type: "text",
    placeholder: "Con chi hai lavorato e cosa non ha funzionato — o \"No, mai\"...",
    minLen: 2,
  },
  {
    id: "q8_obiettivo",
